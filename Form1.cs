...
namespace Kitaplik_Proje
{
    public partial class Form1 : Form
    {
        ...
        OleDbConnection baglanti = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\Kitaplik.mdb");
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            komut.Parameters.AddWithValue("@p6", TxtKitapAd.Text);
            komut.ExecuteNonQuery();
            baglanti.Close();
